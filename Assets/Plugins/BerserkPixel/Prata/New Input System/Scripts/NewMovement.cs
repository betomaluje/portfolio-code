...
namespace Project.Scripts.Player
{
    public class NewMovement : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            _playerInput.climbEvent += OnClimb;
        }
        ...
        {
            rb.linearVelocity = new Vector2(rb.linearVelocityX, climbSpeed * moveInput.x);
        }
        ...
        private void FixedUpdate()
        {
            ...
            {
                float amount = Mathf.Min(Mathf.Abs(rb.linearVelocityY), Mathf.Abs(slideForce));
                amount *= Mathf.Sign(rb.linearVelocityY);
            ...
            if (rb.linearVelocityY < 0 && lastGroundedTime <= 0 && !isSliding)
            {
        ...
        private void WallJump(float jumpForceX, float jumpForceY)
        {
            ...
            float momentumForce = rb.linearVelocityX * Mathf.Sign(jumpForceX);
